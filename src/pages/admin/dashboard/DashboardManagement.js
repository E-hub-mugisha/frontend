                ...
                <div class="row">
                    ...
                    <div class="col-xl-6 col-md-12 d-flex">
                        <div class="dash-earning flex-fill w-100">
                            ...
                            <a role="button" class="withdraw-link" data-bs-toggle="modal" data-bs-target="#withdraw">Withdraw Funds</a>
                        </div>
                    </div>
                </div>
                                        ...
                                        <tbody>
                                            <tr>
                                                <td>
                                                    <div class="d-flex align-items-center">
                                                        <div class="table-img">
                                                            <a role="button"><img src="assets/img/gigs/gigs-07.jpg" class="img-fluid rounded-pill" alt="img"/></a>
                                                        </div>
                                                        <div class="recent-payment">
                                                            <h6><a role="button">I will do creating and promoting video...</a></h6>
                                                            <ul>
                                            ...
                                            <tr>
                                                <td>
                                                    <div class="d-flex align-items-center">
                                                        <div class="table-img">
                                                            <a role="button"><img src="assets/img/gigs/gigs-08.jpg" class="img-fluid rounded-pill" alt="img"/></a>
                                                        </div>
                                                        <div class="recent-payment">
                                                            <h6><a role="button">Optimizing online presence to enhance...</a></h6>
                                                            <ul>
                                            ...
                                            <tr>
                                                <td>
                                                    <div class="d-flex align-items-center">
                                                        <div class="table-img">
                                                            <a role="button"><img src="assets/img/gigs/gigs-09.jpg" class="img-fluid rounded-pill" alt="img"/></a>
                                                        </div>
                                                        <div class="recent-payment">
                                                            <h6><a role="button">I will do english or german transcript of any...</a></h6>
                                                            <ul>
                                            ...
                                            <tr>
                                                <td>
                                                    <div class="d-flex align-items-center">
                                                        <div class="table-img">
                                                            <a role="button"><img src="assets/img/gigs/gigs-04.jpg" class="img-fluid rounded-pill" alt="img"/></a>
                                                        </div>
                                                        <div class="recent-payment">
                                                            <h6><a role="button">I will do professional lifestyle and product...</a></h6>
                                                            <ul>
                                            ...
                                            <tr>
                                                <td>
                                                    <div class="d-flex align-items-center">
                                                        <div class="table-img">
                                                            <a role="button"><img src="assets/img/gigs/gigs-06.jpg" class="img-fluid rounded-pill" alt="img"/></a>
                                                        </div>
                                                        <div class="recent-payment">
                                                            <h6><a role="button">I will develop openai, dalle, chat gpt...</a></h6>
                                                            <ul>
                                                ...
                                                <td>
                                                    <div class="d-flex align-items-center">
                                                        ...
                                                        <div class="card-edit-icon d-flex gap-2">
                                                            <a role="button" class="d-flex align-items-center justify-content-center"><i class="ti ti-info-circle "></i> </a>
                                                            <a role="button" class="d-flex align-items-center justify-content-center"><i class="ti ti-download"></i> </a>
                                                        </div>
                                                    </div>
                                                </td>
                                            </tr>
                                ...
                                <div class="d-flex align-item-center gap-3">
                                    <ul class="revenue-tab nav nav-tabs m-0 border-0" role="tablist">
                                        <li class="nav-item" role="presentation">
                                            <a role="button" class="nav-link active" data-bs-toggle="tab" data-bs-target="#gigs_Information" aria-selected="false" tabindex="-1">
                                                Gigs
                                            </a>
                                        </li>
                                        <li class="nav-item" role="presentation">
                                            <a role="button" class="nav-link" data-bs-toggle="tab" data-bs-target="#pay_Information" aria-selected="false" tabindex="-1">
                                                Payments
                                            </a>
                                        </li>
                                    </ul>
                                    ...
                                    <table class="table">
                                        <tbody>
                                            <tr>
                                                <td>
                                                    <div class="recent-payment">
                                                        <h6><a role="button">I will create a chatbot to change leads..</a></h6>
                                                ...
                                                <td class="text-end amount-info w-25">
                                                    ...
                                                    <a role="button" class="btn btn-primary btn-md" data-bs-toggle="modal" data-bs-target="#transaction_details">View</a>
                                                </td>
                                            </tr>
                                            <tr>
                                                <td>
                                            ...
                                            <tr>
                                                <td>
                                                    <div class="recent-payment">
                                                        <h6><a role="button">I will do professional lifestyle and product ph..</a></h6>
                                            ...
                                            <tr>
                                                <td>
                                                    <div class="recent-payment">
                                                        <h6><a role="button">I will develop openai, dall, chat gpt app for...</a></h6>
                                            ...
                                            <tr>
                                                <td>
                                                    <div class="recent-payment">
                                                        <h6><a role="button">I will develop Website for Ecommerce</a></h6>
                                    ...
                                    <table class="table">
                                        <tbody>
                                            <tr>
                                                <td>
                                                    <div class="recent-payment">
                                                        <h6><a role="button">Your Password Changed</a></h6>
                                                        <p>54 Min Ago</p>
                                                    </div>
                                                </td>
                                            </tr>
                                            <tr>
                                                <td>
                                                    <div class="recent-payment">
                                                        <h6><a role="button">Payment Settings Updated</a></h6>
                                                        <p>1 Hour Ago</p>
                                                    </div>
                                                </td>
                                            </tr>
                                            <tr>
                                                <td>
                                                    <div class="recent-payment">
                                                        <h6><a role="button">Purchased  Gigs “I will do professional..”</a></h6>
                                                        <p>1 Day Ago</p>
                                                    </div>
                                                </td>
                                            </tr>
                                            <tr>
                                                <td>
                                                    <div class="recent-payment">
                                                        <h6><a role="button">Added New Gig “I will do english”.</a></h6>
                                                        <p>15 Min Ago</p>
                                                    </div>
                                                </td>
                                            </tr>
                                            <tr>
                                                <td>
                                                    <div class="recent-payment">
                                                        <h6><a role="button">Profile Updated</a></h6>
                                                        <p>1 Day Ago</p>
                                                    </div>
                                                </td>
                                            </tr>
