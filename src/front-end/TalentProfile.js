					...
					<div class="col-lg-8">
						...
						<div class="slider-card service-slider-card">
							<div class="slider service-slider">
								...
								<div class="service-img-wrap">
									<img src="assets/img/service/service-slide-05.jpg" class="img-fluid"
										alt="img"/>
								</div>
							</div>
							<div class="slider slider-nav-thumbnails">
								<div><img src="assets/img/service/service-slide-01.jpg" class="img-fluid"
										alt="img"/></div>
								<div><img src="assets/img/service/service-slide-02.jpg" class="img-fluid"
										alt="img"/></div>
								<div><img src="assets/img/service/service-slide-03.jpg" class="img-fluid"
										alt="img"/></div>
								<div><img src="assets/img/service/service-slide-04.jpg" class="img-fluid"
										alt="img"/></div>
								<div><img src="assets/img/service/service-slide-05.jpg" class="img-fluid"
										alt="img"/></div>
							</div>
						</div>
						...
						<div class="tab-content">
							...
							<div class="tab-pane fade show active" id="about_me" role="tabpanel">
								...
								<div class="service-wrap">
									<h3>About Me</h3>
									<p>Hello, I'm Adrian, a passionate digital storyteller and performer blending visual
										art and technology. I create immersive experiences that inspire and uplift
										communities.</p>
								</div>
									...
									<div class="container">
										<div class="section-head d-flex">
											...
											<div class="section-tab">
												<ul class="nav nav-pills inner-tab aos aos-init aos-animate"
													...
													<li class="nav-item" role="presentation">
														<button class="nav-link" id="pills-rating-tab"
															...
															type="button" role="tab" aria-controls="pills-rating"
															aria-selected="false" tabindex="-1">Top Ratings</button>
													</li>

													<li class="nav-item" role="presentation">
														<button class="nav-link" id="pills-trend-tab"
															data-bs-toggle="pill" data-bs-target="#pills-trend"
															type="button" role="tab" aria-controls="pills-trend"
															aria-selected="false" tabindex="-1">Trending </button>
													</li>
												</ul>
											</div>
										</div>
